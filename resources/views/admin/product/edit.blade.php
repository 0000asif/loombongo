            ...
            <div class="card card-fullheight">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <label>Price*</label>
                            <input class="form-control" type="number" step="any" name="price" value="{{ $product->price }}" required>
                        </div>

                        <div class="col-md-6 mb-4">
                            <label>Old Price</label>
                            <input class="form-control" type="number" step="any" name="old_price" value="{{ $product->old_price }}">
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <label>Rating</label>
                            <input class="form-control" type="number" step="0.1" name="rating" value="{{ $product->rating }}">
                        </div>
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                @foreach($product->images as $img)
                                    <div class="me-2 mb-2" style="position: relative; display: inline-block;">
                                        <img src="{{ asset($img) }}" width="90" height="90" style="object-fit: cover; border: 1px solid #ddd; padding: 2px;">
