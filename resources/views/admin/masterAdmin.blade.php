...
<head>
    ...
    <link href="{{URL::to('admin/assets/vendors/bootstrap-datepicker/dist/css/bootstrap-datepicker3.min.css')}}" rel="stylesheet" />
    <link href="{{URL::to('admin/assets/vendors/smalot-bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css')}}" rel="stylesheet" />
    ...
    <link href="{{ URL::to('admin/assets/vendors/multiselect/css/multi-select.css') }}" rel="stylesheet" /><!-- THEME STYLES-->
    <link href="{{ URL::to('admin/assets/vendors/select2/dist/css/select2.min.css') }}" rel="stylesheet" />
    <link href="{{ URL::to('admin/assets/css/app.min.css') }}" rel="stylesheet" /><!-- PAGE LEVEL STYLES-->
    {{-- font-awesome cdn --}}
    <link rel="stylesheet" href="{{ URL::to('//stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css') }}">
...
<body>
    ...
    <script src="{{URL::to('admin/assets/vendors/smalot-bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js')}}"></script>
